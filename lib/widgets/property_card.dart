...
class PropertyCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = isHorizontalVariant ? 250.0 : double.infinity; // Lebar penuh untuk list vertikal
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.black.withOpacity(0.4), // Latar belakang sedikit transparan
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween, // Agar tersebar
                  children: [
                    _buildDetailItem(Icons.king_bed_outlined, '${property.bathrooms} Kamar Tidur'),
                    _buildDetailItem(Icons.bathtub_outlined, '${property.bedrooms} Kamar Mandi'),
                    _buildDetailItem(Icons.straighten_outlined, '${property.areaSqft.toStringAsFixed(0)} sqft'), // Format luas
                  ],
                ),
              ],
            ),
